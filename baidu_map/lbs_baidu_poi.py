# -*- coding: utf-8 -*-
'''
Use Baidu Map API to collect POIs
...
def construct_url(lat, lon):
    ...
    # query specific place type
    url = 'http://api.map.baidu.com/place/v2/search?query=教堂$寺庙$清真寺&page_size=20&scope=2&output=json&ak=APIkey'
